...
- Bold monochrome "blueprint" design — Archivo Narrow + IBM Plex Mono, warm paper/ink palette, hairline borders, no drop shadows. Same visual language as [kosten koper](https://kosten-koper.vercel.app) and [xchange rate](https://xchange-rate-ruddy.vercel.app).
